...
![](https://i-blog.csdnimg.cn/blog_migrate/ad202abdd0507d06ff0686cf06ce6bde.png)

![](https://i-blog.csdnimg.cn/blog_migrate/3f4975c5aef12f7440232bb4e847971f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ab5ff9813a7f17f5dd19993e8f94da5a.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/0d22ead9cb4c82b7ed31bc4633ce7480.png)

然后选择需要发送请求的事件，我需要在代码 Push 和提交 PR 的时候触发 pipeline 执行，因此勾选了下面两个：

![](https://i-blog.csdnimg.cn/blog_migrate/47c6900fa8ab8f5484b4052b2ae65731.png)

这样在仓库有代码 Push 和 PR 操作的时候就会向我们的 hook 地址发送请求了，每次发送都会在 webhook 下面生成记录，如图所示：

![](https://i-blog.csdnimg.cn/blog_migrate/1fe7b42fd941654e574acfdfa5200b0c.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/a45e8ebf9b0add3150292ca8e24d1b0a.png)

##### 3. Github Push 触发

Github Push 的触发需要安装 `Github plugin` 插件，然后在 Job 的 `Build Trigger` 中勾选 `GitHub hook trigger for GITScm polling` 即可，如图：
 ![](https://i-blog.csdnimg.cn/blog_migrate/46b740ebd8ce2fba78a4b2a5db8063e6.png)

为了保证触发，项目中必须已经添加了 Jenkinsfile 文件，并在 Job 中指定，如图所示，设置分支和 Jenkinsfile 路径，该 Job 就会监听对应分支的 Github Push 事件。

![](https://i-blog.csdnimg.cn/blog_migrate/6246961173d2f8dbb877cbb42dea0293.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/36f959dcd9b04d7dff388660a05e1733.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/09b946f5cf5924e3ac9e1bf1931be992.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/d3285b1c4b40ba6c9e68d3e926741413.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/04b0983f6c0eb1ee4fc5111a0d648185.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/eb5c503ce61a0c6faef5a15a0d0f06c0.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/18177825ef18f6d6e9124b416c410ba0.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e1e9fc023030a878a2b2bc8ae8566a43.png)
...
![image](https://i-blog.csdnimg.cn/blog_migrate/7b6f8bb9a7c6fbdce985588bfad01984.png)
